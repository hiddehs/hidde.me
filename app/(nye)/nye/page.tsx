        ...
        <div
          ...
          <div
            ...
            <div className="absolute h-full left-0 top-0">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="absolute h-full right-0 top-0" viewBox="0 0 73 170" fill="none">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M0 15.0875C0 14.2008 0.0764979 13.3319 0.223254 12.4872C0.480512 12.4984 0.739481 12.5041 1 12.5041C9.14361 12.5041 15.7715 6.93826 15.9942 0L57.9125 0C66.2451 0 73 6.75492 73 15.0875L73 69.6722C65.5104 69.8931 59.5028 76.4142 59.5028 84.4262C59.5028 92.4383 65.5104 98.9593 73 99.1803L73 154.912C73 163.245 66.2451 170 57.9125 170H15.0875C15.0564 170 15.0253 170 14.9942 170C14.9981 169.88 15 169.76 15 169.639C15 162.567 8.34569 156.827 0.113799 156.775C0.0386807 156.165 0 155.543 0 154.912L0 15.0875Z" fill="#FE4100" fill-opacity="0.2"/>
              </svg>
              <span className="text-2xl absolute right-0 top-1/2 transform -translate-y-1/2 rotate-90">№000001</span>
          ...
          <div
            ...
            <div className="flex flex-wrap gap-4 items-center">
              <div
                ...
                <Input type="text" autoComplete={'fname'} placeholder="Name"/>
              </div>
              <div
                className="grid mb-2 w-full md:w-auto max-w-sm items-center gap-1.5">
                <Label htmlFor="email">Email (if you want updates)</Label>
