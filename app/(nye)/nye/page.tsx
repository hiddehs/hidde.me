...
export default function Page () {
  return (
    <div className={'min-h-[100vh'}>
      <div className="w-full p-12 h-full min-h-[100vh]">
        <div
          className="grid w-full xl:grid-cols-2 grid-cols-1 bg-primary min-h-full p-12 gap-8">
          ...
          <div className="col-span-1 text-right flex flex-col h-full items-end">
            <div className="relative mt-auto font-medium right-[11rem] mb-12">
              <div
                className="ticket-left text-left w-full h-full justify-center pl-12 py-8 flex gap-4 flex-col">
                <h7>31.12.2023 NYE COLDHOUSE<br/>
                  WARMINGHIDDEBIRTHDAYPARTY</h7>
            ...
            <h2 className=" font-medium w-full right-0 top-0">
              get your special unique personalised party fissa ticket
            </h2>
            <div className="p-6 text-left flex flex-col border border-black mt-6 mb-10">
             <div className="flex flex-wrap gap-4 items-center">
               <div className="grid mb-2 w-full md:w-auto max-w-sm items-center gap-1.5">
