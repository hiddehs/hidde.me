  ...
  return (
    <div className="w-full overflow-hidden p-4 md:p-12 h-full min-h-[100vh]">
      ...
      <div
        ...
        <div
          className="relative md:w-auto w-full text-xs mt-auto font-medium mb-12">
          <div
            ...
            <div className="flex items-center gap-4">
              <div
                className="bg-red inline-block rounded-2xl md:px-5 px-3.5 md:rounded-3xl p-4">
                <h3
                  className="text-white font-medium text-lg md:text-2xl leading-none">{ticket.dinner
                  ? '🍝'
                  : '💃'}</h3>
              </div>
          ...
          <div className="absolute h-full left-0 top-0">
            ...
            <span
              className="text-3xl absolute -right-1 top-1/2 transform -translate-y-1/2 rotate-90">№{ticket.no}</span>
