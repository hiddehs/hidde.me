...
export default async function sendTicketMail (
  ...
  const mailResponse = await resend.emails.send({
    ...
    <h1>Hi ${ticket.name}, here's your NYE ticket №${ticket.no}!</h1>
      <p>Check the calendar invite attached, so you won't miss the new year (yes it's already in ${daysLeft} days!) on 31.12.2024 – ${ticket.dinner ? '19':'21'}.00.</p>
      ...
      <p>groetjes, hidde<br\><br\><i style="color: lightgray">this mail was personally automatically generated by HIDDE's NYE PARTY TICKETS SYSTEM SERVICE B.V.LCC.</i></p>
</div>`,
  })
